...
if __name__ == '__main__':
    msg_ds = '{"aps":{"alert":"msg for ios sdk test 2","sound":"","badge":0},"key1":"value1","key2":"value2"}'

    baidu_push_v3('5292273502120587767', msg_ds, device_type=PLATFORM_IOS)
    # baidu_push_v3('5164472022570463351', "早上好，风先生", device_type=PLATFORM_IOS)
    baidu_push_v3('4530182984782816465', "早上好，风先生")
